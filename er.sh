...
# CIL CONFIG
NOTE="er_cifar100_disjoint_iter24" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="er"
...
do
    CUDA_VISIBLE_DEVICES=3 nohup python main.py --mode $MODE --n_worker 8 \
    --dataset $DATASET \
