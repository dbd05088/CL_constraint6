...
# CIL CONFIG
NOTE="der_disjoint_mem50000_iter1" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="der"
...
do
    CUDA_VISIBLE_DEVICES=6 nohup python main.py --mode $MODE --n_worker 3 \
