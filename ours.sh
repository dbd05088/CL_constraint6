...
# CIL CONFIG
NOTE="ours_cifar10_mem50000_get_batch_class_weight_iter1" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ours_v16"
